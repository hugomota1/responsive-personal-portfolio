...
export default function Header() {
  return (
    <header className="z-10 max-w-5xl w-full items-center justify-center font-mono text-lg">
      <nav className="fixed left-0 top-0 flex w-full items-center justify-between border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 px-3 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
        <a
